...
const App = () => {
  ...
  <div className="App min-h-screen text-blue-200 d-flex align-items-center justify-content-center">
    ...
    <a id='donate-head' aria-label="Donate" href="https://paypal.me/islandboyluna" target="_blank" rel="noopener noreferrer" className={support ? 'animated bounceOut': 'animated bounceIn'} > <FontAwesomeIcon icon={faHeart} /> Help this server stay alive!<FontAwesomeIcon className="socials-icn close-icn" icon={faTimes} onClick={supportClick} /></a>
    ...
    <footer>
      <div className="footer-socials">
        ...
        <a aria-label="Support" data-tooltip="Support" href="https://www.buymeacoffee.com/internetboy" target="_blank" rel="noopener noreferrer" ><FontAwesomeIcon className="socials-icn" icon={faPaypal} /></a>
      </div>
    </footer>
  </div>
)};
